                    ...
                    <ScrollView style={{height: '100%', backgroundColor: style.white}}>
                        <View style={styles.container}>
                            ...
                            <View style={{marginTop: 40}}>
                                ...
                                <Text style={{textAlign: 'center', fontSize: 16, marginBottom: 15}}>Did you forgot your password?</Text>
                                <TouchableOpacity style={{borderBottomWidth: 0.5, borderBottomColor: style.primary, marginBottom: 40, width: 150, alignSelf: 'center'}}>
                                    <Text style={{textAlign: 'center', color: style.primary, fontSize: 16}}>Tap here for reset</Text>
                                </TouchableOpacity>
